...
<svg class="icon icon-download2 contact-img">
<use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-download2">
</use>
</svg>
<p class="contact-text">Eum tempora facere dignissimos perspiciatis, 
						   nihil quasi accusantium delectus itaque vitae quaerat 
						   nemo corporis molestias quis nobis.
	<a href="">Contact</a>
</p>
